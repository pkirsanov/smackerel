...
| Answer-quality regression | **Cannot be triggered at all today** | No retrieval-evaluation gate exists ([`business-plan.md`](business-plan.md) R2). Quality regressions are currently **invisible**, not merely unalerted. |
