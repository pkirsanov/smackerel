...
PHOTOS_PROVIDER_IMMICH_TLS_SKIP_VERIFY="$(required_value photos.providers.immich.tls_skip_verify)"
...
PHOTOS_PROVIDER_PHOTOPRISM_TLS_SKIP_VERIFY="$(required_value photos.providers.photoprism.tls_skip_verify)"
...
PHOTOS_PROVIDER_IMMICH_TLS_SKIP_VERIFY=${PHOTOS_PROVIDER_IMMICH_TLS_SKIP_VERIFY}
...
PHOTOS_PROVIDER_PHOTOPRISM_TLS_SKIP_VERIFY=${PHOTOS_PROVIDER_PHOTOPRISM_TLS_SKIP_VERIFY}
