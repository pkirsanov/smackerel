...
func TestSCN002054_GoSubjectsMatchContract(t *testing.T) {
	...
	goSubjects := map[string]string{
		...
		"SubjectSynthesisExtract":           SubjectSynthesisExtract,
		...
		"SubjectDriveExtractRequest":        SubjectDriveExtractRequest,
		"SubjectDriveExtractResult":         SubjectDriveExtractResult,
		"SubjectDriveClassifyRequest":       SubjectDriveClassifyRequest,
		"SubjectDriveClassifyResult":        SubjectDriveClassifyResult,
...
func TestSCN002054_GoSubjectPairsMatchContract(t *testing.T) {
	...
	goPairs := []struct{ request, response string }{
		...
		{SubjectDriveExtractRequest, SubjectDriveExtractResult},
		{SubjectDriveClassifyRequest, SubjectDriveClassifyResult},
