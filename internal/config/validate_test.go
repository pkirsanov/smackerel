...
func setRequiredEnv(t *testing.T) {
	...
	t.Setenv("RECOMMENDATIONS_WATCHES_DEFAULT_PRICE_DROP_THRESHOLD_PCT", "0.10")
	...
	t.Setenv("ASSISTANT_OPEN_KNOWLEDGE_SYNTHESIS_MODEL_ID", "")
	t.Setenv("ASSISTANT_OPEN_KNOWLEDGE_MAX_ITERATIONS", "8")
	t.Setenv("ASSISTANT_OPEN_KNOWLEDGE_SYNTHESIS_RETRY_BUDGET", "1")
	...
	t.Setenv("ASSISTANT_OPEN_KNOWLEDGE_SWITCHABLE_MODELS", `[]`)
	t.Setenv("ASSISTANT_OPEN_KNOWLEDGE_TOOL_CAPABLE_GATHER_MODELS", `[]`)
