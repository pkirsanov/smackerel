...
func minimalAssistantEnv() map[string]string {
	return map[string]string{
		...
		// Spec 071 SCOPE-01 — IntentTrace SST.
		"ASSISTANT_INTENT_TRACE_SAMPLING_RATIO":           "1.0",
		"ASSISTANT_INTENT_TRACE_RETENTION_DAYS":           "14",
		"ASSISTANT_INTENT_TRACE_EXPORT_TARGETS":           "structured_log,otel,prometheus",
		"ASSISTANT_INTENT_TRACE_REPLAY_ENABLED":           "true",
		"ASSISTANT_INTENT_TRACE_RETENTION_SWEEP_INTERVAL": "1h",
		// Spec 065 — micro-tools SST.
		"ASSISTANT_TOOLS_LOCATION_NORMALIZE_ENABLED":           "true",
		...
		"ASSISTANT_TOOLS_UNIT_CONVERT_ENABLED":                 "true",
		"ASSISTANT_TOOLS_UNIT_CONVERT_CATALOG_VERSION":         "v1",
		"ASSISTANT_TOOLS_CALCULATOR_ENABLED":                   "true",
		...
		"ASSISTANT_TRANSPORTS_HTTP_SHARED_USER_ID":                 "shared",
