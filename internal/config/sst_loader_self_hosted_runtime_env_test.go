...
// SST-loader self-hosted runtime-env-mode shell regression.
//
// The shell file scripts/commands/config_self_hosted_runtime_env_test.sh owns
...
//
//   - Sub-test 1 (BUG-051-001 core): TARGET_ENV=self-hosted emits
...
//   - Sub-test 4 (defense-in-depth): TARGET_ENV=self-hosted against the
...
func TestSSTLoader_SelfHostedEmitsProductionRuntimeEnv_BUG051001(t *testing.T) {
