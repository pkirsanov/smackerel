...
func TestNtfyReconnectLagAndGapPersistInTopicState(t *testing.T) {
	...
	cfg := ntfyIntegrationConfig(prefix, notification.SourceFormStream, []string{"self-hosted-alerts"})
