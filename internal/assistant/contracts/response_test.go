	...
	return []goldenCase{
		...
		},
		{
			...
			resp: AssistantResponse{
				...
				Body:   "Ocean Shores 06/11: high 7:42am 8.9 ft, low 1:55pm 0.3 ft.",
				Sources: []Source{
					{ID: "w-1", Title: "tidetime.org", Kind: SourceWeb, Ref: WebSourceRef{URL: "https://tidetime.org/ocean-shores", Provider: "searxng", FetchedAt: t0, ContentHash: "sha256:tide", Snippet: "Ocean Shores tide times"}},
				},
				EmittedAt: t0,
			},
		},
