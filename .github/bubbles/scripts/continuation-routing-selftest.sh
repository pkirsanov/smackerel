...
check_pattern "$ROOT_DIR/../agents/bubbles.workflow.agent.md" 'preserve that mode\. Do NOT silently collapse it to `full-delivery`' "Workflow agent preserves stochastic sweep mode during resume"
