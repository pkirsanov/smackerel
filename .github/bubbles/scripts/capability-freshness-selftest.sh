...
rewrite_once "$TMP_ROOT/docs/generated/competitive-capabilities.md" 'State summary: 20 shipped, 1 partial, 0 proposed.' 'State summary: 2 shipped, 1 partial, 4 proposed.'
