...
check_pattern "$ROOT_DIR/docs/generated/interop-migration-matrix.md" '^Capability context: 12 shipped, 1 partial, 0 proposed\.$' "Generated interop migration matrix exposes the same state summary the README advertises"
