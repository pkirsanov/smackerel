...
- Declared `behavioral:` (agent-behavior enforcement, by design): **2**
- Declared `unbound`: **0**
...
| --- | --- | --- | --- | --- | --- | --- |
| G001 | artifact_gate | `mode-required` | 56 | — | 19 | — |
| G002 | scope_definition_gate | `mode-required` | 23 | — | 11 | — |
| G003 | test_integrity_gate | `mode-required` | 25 | — | 9 | — |
| G004 | test_execution_gate | `mode-required` | 25 | — | 4 | — |
| G005 | evidence_gate | `mode-required` | 25 | — | 4 | — |
...
| G010 | user_validation_gate | `mode-required` | 31 | — | 3 | — |
| G011 | session_gate | `mode-required` | 56 | — | 2 | — |
...
| G020 | cross_agent_verification_gate | `mode-required` | 25 | — | 2 | — |
...
| G026 | sla_stress_coverage_gate | `guard-check:5A` | 22 | ref | 4 | guard |
| G027 | phase_scope_coherence_gate | `guard-check:15` | 25 | Check 15 | 4 | guard |
| G028 | implementation_reality_scan_gate | `guard-check:16` | 23 | Check 16 | 7 | guard |
...
| G041 | dod_format_integrity_gate | `guard-check:4A`, `guard-check:4B` | 0 | Check 4A, Check 4B | 3 | guard |
...
| G057 | scenario_manifest_gate | `script:bubbles/scripts/guards/control-plane-checks.sh` | 25 | Check 3C | 6 | guard |
...
| G063 | concrete_result_gate | `guard-check:3G` | 0 | Check 3G | 4 | guard |
...
| G071 | execution_only_validation_gate | `behavioral:agents/bubbles_shared/evidence-rules.md`, `behavioral:agents/bubbles_shared/quality-gates.md`, `behavioral:agents/bubbles_shared/state-gates.md`, `behavioral:agents/bubbles_shared/validation-core.md`, `behavioral:bubbles.validate` | 0 | — | 4 | — |
| G072 | evidence_provenance_gate | `guard-check:12` | 0 | Check 40 | 6 | guard |
| G073 | planning_only_source_edit_lockout_gate | `guard-check:3B` | 31 | Check 3B | 6 | guard |
| G074 | workflow_mode_consistency_gate | `guard-check:2B` | 3 | ref | 2 | guard |
...
| G090 | retro_convergence_health_evidence_gate | `script:bubbles/scripts/retro-convergence-health-selftest.sh`, `script:bubbles/scripts/retro-convergence-health.sh` | 0 | Check 33 | 8 | guard |
...
| G093 | delivery_implementation_delta_gate | `script:bubbles/scripts/delivery-implementation-delta-guard-selftest.sh`, `script:bubbles/scripts/delivery-implementation-delta-guard.sh` | 0 | Check 29B | 4 | guard |
...
| G099 | observability_opt_out_freshness_gate | `script:bubbles/scripts/observability-opt-out-guard-selftest.sh`, `script:bubbles/scripts/observability-opt-out-guard.sh` | 0 | Check 38 | 11 | guard |
...
| G101 | release_delivery_reconciliation_gate | `script:bubbles/scripts/is-terminal-for-mode.sh`, `script:bubbles/scripts/release-delivery-reconciliation-guard-selftest.sh`, `script:bubbles/scripts/release-delivery-reconciliation-guard.sh`, `script:bubbles/scripts/scenario-compile-lint.sh` | 0 | — | 11 | — |
...
| G128 | session_cap_enforcement_gate | `script:bubbles/scripts/session-cap-guard-selftest.sh`, `script:bubbles/scripts/session-cap-guard.sh` | 0 | Check 40 | 12 | guard |
...
| G134 | goal_fidelity_gate | `script:bubbles/scripts/goal-fidelity-guard.sh`, `script:bubbles/scripts/goal-fidelity-guard-selftest.sh` | 0 | — | 10 | — |
...
| G041 | dod_format_integrity_gate | Check 4A, Check 4B | 3 | guard | compact-obligation-basis-selftest.sh, evidence-admission-hardening-selftest.sh, v4.1.0-selftest.sh |
...
| G063 | concrete_result_gate | Check 3G | 4 | guard | agent-ownership-lint.sh, gate-telemetry-capability-lint-selftest.sh, gate-telemetry-capability-lint.sh, state-transition-guard-selftest.sh |
...
| G071 | execution_only_validation_gate | — | 4 | — | gate-id-grep-selftest.sh, gate-id-grep.sh, generate-gate-enforcement-selftest.sh, generate-gate-enforcement.sh |
| G072 | evidence_provenance_gate | Check 40 | 6 | guard | claim-source-lint.sh, domain-model-consistency.sh, framework-validate.sh, gate-strength-lint.sh, gate-telemetry-capability-lint-selftest.sh, gate-telemetry-capability-lint.sh |
...
| G090 | retro_convergence_health_evidence_gate | Check 33 | 8 | guard | gate-telemetry-capability-lint-selftest.sh, observability-slo-guard-selftest.sh, observability-slo-guard.sh, retro-convergence-health-selftest.sh, retro-convergence-health.sh, scaffold-gate-selftest.sh, +2 more |
...
| G093 | delivery_implementation_delta_gate | Check 29B | 4 | guard | delivery-implementation-delta-guard-selftest.sh, delivery-implementation-delta-guard.sh, state-transition-guard-perf-selftest.sh, state-transition-guard-selftest.sh |
...
| G099 | observability_opt_out_freshness_gate | Check 38 | 11 | guard | cli.sh, framework-validate.sh, gate-enforcement-agreement-ratchet-selftest.sh, gate-hit-log-selftest.sh, gate-id-grep-selftest.sh, observability-opt-out-guard-selftest.sh, +5 more |
...
| G101 | release_delivery_reconciliation_gate | — | 11 | — | adversarial-resolve.sh, framework-validate.sh, is-terminal-for-mode.sh, release-delivery-reconciliation-guard-selftest.sh, release-delivery-reconciliation-guard.sh, release-ladder-schema-guard.sh, +5 more |
...
| G128 | session_cap_enforcement_gate | Check 40 | 12 | guard | cli.sh, framework-validate-tier-selftest.sh, framework-validate.sh, gate-telemetry-capability-lint-selftest.sh, rapid-tool-delivery-mode-selftest.sh, risk-tier-resolve.sh, +6 more |
...
| G134 | goal_fidelity_gate | — | 10 | — | framework-validate.sh, goal-boundary-receipt-selftest.sh, goal-boundary-receipt.sh, goal-fidelity-guard-selftest.sh, goal-fidelity-guard.sh, mutable-dispatch-authorization-selftest.sh, +4 more |
