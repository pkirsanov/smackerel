...
| `.specify/runtime/dispatch-receipts.jsonl` | `undeclared` | `bubbles/scripts/dispatch-receipt-selftest.sh`<br>`bubbles/scripts/dispatch-receipt.sh` | direct | code only |
...
| `.specify/runtime/gate-hits.jsonl` | `bubbles/scripts/gate-hit-log.sh` | `bubbles/scripts/cli.sh`<br>`bubbles/scripts/gate-hit-log-selftest.sh`<br>`bubbles/scripts/generate-telemetry-reader-map-selftest.sh`<br>`bubbles/scripts/retro-framework-health-selftest.sh`<br>`bubbles/scripts/retro-framework-health.sh` | direct | `gateTelemetry` |
| `.specify/runtime/micro-fix-outcomes.jsonl` | `undeclared` | `bubbles/scripts/micro-fix-outcome-log.sh` | direct | code only |
...
| `.specify/runtime/tool-calls.jsonl` | `undeclared` | `bubbles/scripts/evidence-admission-hardening-selftest.sh`<br>`bubbles/scripts/evidence-tool-log-bridge-selftest.sh`<br>`bubbles/scripts/evidence-tool-log-bridge.sh`<br>`bubbles/scripts/observability-check.sh`<br>`bubbles/scripts/observability-slo-guard.sh`<br>`bubbles/scripts/scenario-state-resolve.sh`<br>`bubbles/scripts/session-cap-guard-selftest.sh`<br>`bubbles/scripts/session-cap-guard.sh`<br>`bubbles/scripts/state-transition-guard-selftest.sh`<br>`bubbles/scripts/state-transition-guard.sh`<br>`bubbles/scripts/tool-capture-shim-selftest.sh`<br>`bubbles/scripts/tool-capture-shim.sh`<br>`bubbles/scripts/tool-log-semantic-admission-selftest.sh`<br>`bubbles/scripts/tool-log.sh` | direct | code only |
| `.specify/runtime/validation-debt` | `undeclared` | `bubbles/scripts/framework-validate.sh`<br>`bubbles/scripts/validation-batch.sh`<br>`bubbles/scripts/validation-debt.sh` | direct | code only |
...
19 store(s): derived 1, direct 17, unmeasured 1.
