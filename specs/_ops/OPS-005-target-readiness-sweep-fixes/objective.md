# Ops Packet: [OPS-005] <deploy-host> Readiness-Sweep Fixes
...
> **Sibling packets:** [`OPS-004`](../OPS-004-selfhosted-activation-handoff/) (shape
...
This packet tracks the smackerel-side findings from the <deploy-host> readiness sweep
...
> Keep `OLLAMA_KEEP_ALIVE` resident on self-hosted (`-1` or a duration ≥ 10m): the
...
- **F3** — covers the two previously-omitted self-hosted handoff packets:
