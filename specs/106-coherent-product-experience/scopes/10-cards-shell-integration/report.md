# Report: SCOPE-106-10 Cards Shell Integration
...
## Decision Record
The scope consumes all 18 BUG-083 scopes and owns no Card domain repair.
...
BUG-083 Scopes 01-18 are the external entry gate.
