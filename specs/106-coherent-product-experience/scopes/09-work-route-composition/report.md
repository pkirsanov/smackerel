# Report: SCOPE-106-09 Lists Meals And Expenses Route Composition
...
## Decision Record
The scope activates no leaf without exact route/API/owner evidence.
...
The exact inventory determines whether each Work leaf is eligible for pickup.
