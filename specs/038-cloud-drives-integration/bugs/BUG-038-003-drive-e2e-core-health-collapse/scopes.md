...
**Excluded surfaces:** Drive production runtime, blind timeout extension, arbitrary sleep, all-package E2E, parent packet edits, deployment, `<deploy-host>`, `<knb-repo>`, and release-train configuration.
