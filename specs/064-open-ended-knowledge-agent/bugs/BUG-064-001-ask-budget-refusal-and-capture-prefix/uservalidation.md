...
- [ ] LIVE: on the home-lab bot, `/ask tide schedule for 06/11 in ocean shores, wa` returns a sourced answer instead of "I don't have a sourced answer for that." — **pending the bubbles.devops redeploy** of the fixed SHA + regenerated home-lab config bundle.
