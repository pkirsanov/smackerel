...
=== NAME  TestHandleUpdate_BUG064001_CaptureStripsAskPrefix
    capture_prefix_bug064001_test.go:66: DEFECT B regression: captured text still carries the /ask prefix: "/ask tide schedule for 06/11 in ocean shores, wa"
--- FAIL: TestHandleUpdate_BUG064001_CaptureStripsAskPrefix (0.00s)
    capture_prefix_bug064001_test.go:127: /ask: captured text = "/ask tide schedule for ocean shores"; want "tide schedule for ocean shores" (prefix stripped)
    capture_prefix_bug064001_test.go:127: /weather: captured text = "/weather in ocean shores wa tomorrow"; want "in ocean shores wa tomorrow" (prefix stripped)
