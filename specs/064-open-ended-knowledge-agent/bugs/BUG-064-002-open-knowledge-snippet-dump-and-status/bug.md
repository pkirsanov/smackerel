...
```
ask tide schedule for 06/11 in ocean shores, wa, provide actual highs and lows (time + ft)
```
...
- Then the SAME web-search snippet block repeated **three times** verbatim:
  > "Tide Times · Home · United States; Ocean Shores tides. Ocean Shores Tide
  > Times, Washington. Tide Times Today & Tomorrow. « Thu, June 11. Ocean Shores
  > tide today …"
