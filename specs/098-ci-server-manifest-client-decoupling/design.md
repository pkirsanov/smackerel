...
| A clients-absent, server-deployable manifest already exists (`local-build-manifest-<sha>.yaml`: core + ml + self-hosted bundle, operator-cosign-signed, no Android secret) | `scripts/commands/build-self-hosted.sh` steps 1–9 |
