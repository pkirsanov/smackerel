...
```gherkin
Scenario: SCN-097-A01 — Monthly recommendation is written to Google Calendar (live home-lab proof)
  Given the new signed image is deployed on the home-lab host with calendar_sync
