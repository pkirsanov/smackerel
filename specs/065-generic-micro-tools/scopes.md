...
| Foundation no-auto-register canary | unit | SCN-065-A07 | `internal/agent/tools/microtools/registry_canary_test.go` | `microtools_foundation_did_not_register_any_tool` | `./smackerel.sh test unit` | No |
