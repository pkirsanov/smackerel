# Scopes — 082 MVP / evo-x2 Readiness Hardening
...
- `config/smackerel.yaml` — `environments.home-lab.ollama_memory_limit: "28G"`.
...
- [x] D02-4 — `environments.home-lab.ollama_memory_limit` raised to `"28G"` with documented rationale.
...
- [x] D02-6 — `docs/Operations.md` documents the concurrent-envelope guard + home-lab 28G floor.
