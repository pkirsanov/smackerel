...
- [ ] **What:** `./smackerel.sh test integration` executes `TestAcceptanceGate_RoutingAccuracyAndCaptureFallback` and reports a non-zero executed-assertion count; a run in which the gate did not execute fails instead of passing green.
  - **Steps:**
