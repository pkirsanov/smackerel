...
model: inherit
tools: Agent(bubbles-audit, bubbles-devops, bubbles-docs, bubbles-gaps, bubbles-harden, bubbles-implement, bubbles-iterate, bubbles-regression, bubbles-security, bubbles-simplify, bubbles-stabilize, bubbles-test, bubbles-validate), Read, Grep, Glob, Edit, Write, Bash, TodoWrite, WebFetch, WebSearch, mcp__bubbles
---
