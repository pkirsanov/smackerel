...
model: inherit
tools: Agent(bubbles-audit, bubbles-chaos, bubbles-devops, bubbles-docs, bubbles-implement, bubbles-iterate, bubbles-redteam, bubbles-regression, bubbles-security, bubbles-simplify, bubbles-test, bubbles-validate), Read, Grep, Glob, Edit, Write, Bash, TodoWrite, WebFetch, WebSearch, mcp__bubbles
---
