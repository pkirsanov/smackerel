...
model: inherit
tools: Agent(bubbles-audit, bubbles-devops, bubbles-docs, bubbles-iterate, bubbles-security, bubbles-validate), Read, Grep, Glob, Edit, Write, Bash, TodoWrite, WebFetch, WebSearch, mcp__bubbles
---
