// Smackerel — CaptureQueue (IndexedDB)
// Shared offline queue for pending captures.
// Used by both the PWA service worker and the browser extension.
'use strict';
...
// Export for module environments (Node.js testing)
