...
func TestIntegration_CorpusGrantEnv_EmittedForEveryEnvironment_TP_05_03(t *testing.T) {
	...
	// that environment — a deploy-target env file on this box predates the flag by
	// two months. Asserting over every file present would make the result depend on
