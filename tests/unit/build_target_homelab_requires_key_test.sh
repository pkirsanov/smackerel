#!/usr/bin/env bash
# tests/unit/build_target_homelab_requires_key_test.sh
#
...
echo "PASS: build --target home-lab refuses to start without operator key OR without COSIGN_PASSWORD (F017-BUILD-01 in both cases)"
