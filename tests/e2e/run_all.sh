...
LIFECYCLE_TESTS="test_timeout_process_cleanup test_compose_start test_persistence test_postgres_readiness_gate test_config_fail synthesis_restart_durability_e2e_test synthesis_prior_source_compatibility_e2e_test synthesis_recovery_health_e2e_test"
