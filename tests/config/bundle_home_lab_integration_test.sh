#!/usr/bin/env bash
# Spec 052 SCN-052-S02 / NFR Determinism — bundle home-lab integration test.
#
# Asserts that two consecutive `smackerel config generate --env home-lab
...
BUNDLE_NAME="config-bundle-home-lab-${SOURCE_SHA}.tar.gz"
